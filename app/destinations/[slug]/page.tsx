...
if (!dest) return {};
return {
title: 'السياحة في ' + dest.name + ' | HBS Travel',
...
h('img', { src: dest.image, alt: dest.name, style: { height: '260px', width: '100%', objectFit: 'cover', borderRadius: '14px', marginBottom: '18px' } }),
