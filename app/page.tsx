...
h(
'section',
{ style: { background: 'linear-gradient(135deg, rgba(14,90,99,0.88), rgba(15,42,58,0.92)), url(' + heroImage + ')', backgroundSize: 'cover', backgroundPosition: 'center', color: '#f6efe3', padding: '64px 0' } },
h(
'div',
...
h('img', { src: p.image, alt: p.title, style: { height: '160px', width: '100%', objectFit: 'cover', borderRadius: '12px 12px 0 0' } }),
h(
'div',
{ style: { padding: '16px' } },
...
h('img', { src: d.image, alt: d.name, style: { height: '110px', width: '100%', objectFit: 'cover', borderRadius: '12px 12px 0 0' } }),
