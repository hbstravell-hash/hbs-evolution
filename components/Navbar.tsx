...
h('img', { src: 'https://hbstravel.ge/logo.png', alt: 'HBS Travel', style: { height: '36px', width: '36px', objectFit: 'contain' } }),
h('span', { style: { fontWeight: 800, fontSize: '22px', color: '#f6efe3' } }, 'HBS Travel')
),
h(
'nav',
